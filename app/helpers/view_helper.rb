module ViewHelper
  ...
  def order_status(status)
    ...
    labels = {
      beklemede: 'label-default',
      onaylı: 'label-default',
      kargoda: 'label-primary',
      tamamlandı: 'label-success'
    }

    icons = {
      beklemede: 'fa-clock-o',
      onaylı: 'fa-archive',
      kargoda: 'fa-truck',
      tamamlandı: 'fa-check-circle'
    }

    texts = {
      beklemede: _('Accepted'),
      onaylı: _('In progress'),
      kargoda: _('Shipped'),
      tamamlandı: _('Completed')
    }
